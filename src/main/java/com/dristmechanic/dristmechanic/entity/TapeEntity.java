...
public class TapeEntity extends AbstractArrow implements ItemSupplier {
    public static final ItemStack PROJECTILE_ITEM = ItemStack.EMPTY;
    private int knockback = 0;

    public TapeEntity(EntityType<? extends TapeEntity> type, Level world) {
        super(type, world);
    }

    public TapeEntity(EntityType<? extends TapeEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
    ...
    public TapeEntity(EntityType<? extends TapeEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
    ...
    public static TapeEntity shoot(LivingEntity entity, LivingEntity target) {
        TapeEntity entityarrow = new TapeEntity(ModEntities.TAPE.get(), entity, entity.level(), null);
